---
name: hdx-hapi
description: Use when the user needs current humanitarian operational data from HDX HAPI through the local hapi CLI, including data availability, operational presence, funding, food security, IDPs, humanitarian needs, and source metadata citations.
---
